...
import clickhere from '../img/ch.jpg'
...
const MenuContainer = () => {
  ...
  return (
   ...
   <p className="text-2xl font-semibold capitalize text-headingColor relative before:absolute before:rounded-lg before:content before:w-16 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-orange-400 to-orange-600 transition-all ease-in-out duration-100 mr-auto">
     ...
     {!li && (
      <div className="w-full pt-3 pb-3 pl-36 h-56 mt-5  bg-blue-300 text-3xl font-bold flex items-center justify-center drop-shadow-sm bg-opacity-50 cursor-pointer gap-4" onClick={login}>
      <img className="w-36 h-36 rounded-full " src={clickhere}   />
      <div >Click here and Login to access question papers</div>
